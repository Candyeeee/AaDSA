...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--arch', type=str, default='swinIR', help='network arch')
        ...
        self.parser.add_argument('--name', type=str, default='vDSA_wnewdata_wmask_swinIR', help='name of the experiment')
